...
class Step:
    ...
    def __init__(self, iteration: int, iterations_per_epoch: int) -> 'Step':
        ...
        if int(iteration) != iteration: raise ValueError('iteration must be equivalent to int')
        if int(iterations_per_epoch) != iterations_per_epoch: raise ValueError('iterations_per_epoch must be equivalent to int')
        self._iteration = int(iteration)
        self._iterations_per_epoch = int(iterations_per_epoch)
